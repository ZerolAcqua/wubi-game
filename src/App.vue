<template>
  <el-container>
    <el-header class="el-menu-demo">
      <el-row>
        <el-col
          ...
          :md="{ span: 18, offset: 3 }"
          :xl="{ span: 12, offset: 6 }"
          ><h1 style="margin: 0 20px; float: left; line-height: 60px">
            五笔练习
          </h1>
          <el-menu
          ...
          >
            <el-sub-menu index="0" v-if="windowWidth < 640">
              <template v-slot:title
                ><i style="color: #fff" class="el-icon-s-unfold"></i
              ></template>
              <el-menu-item index="1">字根练习</el-menu-item>
              <el-menu-item index="2">一级简码</el-menu-item>
              <el-menu-item index="3">二级简码</el-menu-item>
              <el-menu-item index="4"
                ><i style="color: #f56c6c" class="el-icon-document"></i
                ><a
    ...
    <el-footer style="text-align: center"
      ...
      <a href="https://yantuz.cn/">岩兔站</a></el-footer
    >
  </el-container>
</template>
